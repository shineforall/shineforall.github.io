...
function(i) {
    ...
    i.fn.fitVids = function(e) {
        ...
        function d() {
            ...
            console.log("visible-links.children():",i.children())
            console.log("hidden-links.children():",a.children())
        ...
        function b() {
            ...
            console.log("lastBreakpoint:",e)

            e !== y && d(), 
            y = e, 
            h = i.children().length, 
            console.log("h:visible-links.length=",h),
